# require3 - EPICS module for dynamically loading functionality at runtime

In general, EPICS IOCs are built as statically or dynamically linked executables.
`require3` provides a third option: dynamically load the EPICS module during IOC
startup.

In order to do this, `require3` provides a wrapper utility, `iocsh` that calls and
...
`require3` provides at its heart three main components:
...
For more information, please see the [official documentation](http://epics-e3.github.io/).
